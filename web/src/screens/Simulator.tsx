  ...
  return (
    <li className="py-3">
      <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
        <span className="text-[0.8125rem] text-ink">{c.name}</span>
      ...
      <div className="num mt-1.5 text-[0.6875rem] text-ink-3">
  ...
  return (
    <div className="space-y-4 px-4 py-5 sm:px-6">
      ...
      >
        ...
        <div className="mt-4 flex flex-wrap gap-x-5 gap-y-1.5 text-[0.6875rem] text-ink-3">
          <span>
        ...
        <p className="prose-sans mt-3 border-t border-rule pt-3 text-[0.75rem] text-ink-2">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Panel name="rule trigger rates" tone="value">
          ...
          <p className="prose-sans mt-4 border-t border-rule pt-3 text-[0.75rem] text-ink-2">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Panel name="entity graph: why degrees are generated first" tone="def">
          ...
          <p className="prose-sans mt-4 border-t border-rule pt-3 text-[0.8125rem] leading-relaxed text-ink-2">
        ...
        <ul className="mt-4 space-y-2.5">
          {[
            ...
            <li key={line} className="flex gap-2.5">
              ...
              <span className="prose-sans text-[0.8125rem] leading-relaxed text-ink-2">{line}</span>
            </li>
          ))}
        </ul>
