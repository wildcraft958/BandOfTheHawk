"""Configuration entry points.
    ...
    python -m fraudsim.config.cli show        resolved values with their origin
    python -m fraudsim.config.cli provenance  the origin table alone
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="fraudsim.config")
